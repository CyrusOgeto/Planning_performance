...
// export const Route = createFileRoute("/performance-contracts/explanatory-presidential")({
//   component: ExplanatoryPresidentialPage,
// });
...
function ExplanatoryPresidentialPage() {
  const [indicator, setIndicator] = useState("");
  const [statement, setStatement] = useState("");

  return (
    <div className="max-w-4xl">
      <h1 className="mb-6 text-xl font-bold text-emerald-800">Explanatory Notes - Presidential Directives</h1>
      ...
      <div className="mb-6 overflow-hidden rounded border border-gray-200 bg-white">
        ...
        <PCFormRow label="Presidential Directives Indicators *" required>
...
export default ExplanatoryPresidentialPage;