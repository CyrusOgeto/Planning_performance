...
// export const Route = createFileRoute("/performance-contracts/matrix-presidential")({
//   component: MatrixPresidentialPage,
// });

const INDICATORS = [
  "Implementation of Presidential Directives",
  "Compliance with Presidential Directives",
  "Presidential Pledges Implementation",
];
const UNITS = ["%", "Kshs.", "Number", "Days"];

const INITIAL_DATA = [
  { indicator: "Implementation of Presidential Directives", unit: "%", weight: "2.00", statusPrev: "100.00", annualTarget: "100.00" },
];
...
function MatrixPresidentialPage() {
  ...
  return (
    <div className="max-w-4xl">
      <h1 className="mb-6 text-xl font-bold text-emerald-800">Implementation of Presidential Directives</h1>
      ...
      <div className="mb-6 overflow-hidden rounded border border-gray-200 bg-white">
        ...
        <PCFormRow label="Implementation of Presidential Directives Performance Indicator*" required>
...
export default MatrixPresidentialPage;